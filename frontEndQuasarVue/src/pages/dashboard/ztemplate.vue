<template>
    ...
    <div class="row full-width">
      ...
      <div class="col-xs-12 xol-sm-12 col-md-12 col-lg-12 adminheadingpadding">
        <h5 class="text-white text-center margin-0 "> Zones From Email Message </h5>
      </div>
...
export default defineComponent ({
    ...
    methods: {
      ...
      async loadData() {
        ...
        let response: any;
            try {
                ...
                response = await axios.get(api.get_ztemplate
                , {
                    headers: {
                        Authorization: token,
                    },
      ...
      async updateContent() {
            ...
            try {
                 let token: string = getAuthorizationToken();
                response = await axios.post(api.update_ztemplate, formData
                 , {
                     headers: {
                         Authorization: token,
                     },
